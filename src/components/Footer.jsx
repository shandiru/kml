...
export default function Footer() {
  ...
  // Optional UX touch: disable background scroll when modal is open
  useEffect(() => {
    if (isModalOpen) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
            ...
            <div>
              ...
              <p className="text-sm mb-4 opacity-90 font-serif text-gray-300 leading-relaxed">
                Your trusted partner for professional insurance repairs,
                collision work, and complete automotive repair services.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm opacity-90 font-serif">
                ...
                {/* ✅ Free Estimates button opens modal */}
                <li>
                  <a
                    href="#"
                    onClick={openModal}
