...
export default function QuoteModal({ onClose }) {
  return (
    <div className="fixed inset-0 z-50 bg-black/50 dark:bg-black/70 flex justify-center items-start overflow-y-auto">
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-2xl p-8 relative mt-10 mb-10 mx-4 transition-colors">
          ...
          {steps.map((s, i) => (
            <div key={i} className="flex items-start gap-6">
              ...
              <div className="flex flex-col items-center">
                <div
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white shadow-md bg-blue-600 dark:bg-blue-500"
                >
                  {s.icon}
                </div>
                {i < steps.length - 1 && (
        ...
        <div className="mt-10 border-t border-gray-200 dark:border-gray-700 pt-6 text-center">
          ...
          <a
            ...
            className="inline-block text-white font-medium py-2 px-6 rounded-lg shadow-md 
